...
- **Load:** `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-04-idea-organization.md`
...
After technique completion and user confirmation, load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-04-idea-organization.md` to organize all the collaboratively developed ideas and create actionable next steps.
