...
- **Load:** `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-04-idea-organization.md`
...
After technique completion and user confirmation, load `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-04-idea-organization.md` to organize all the collaboratively developed ideas and create actionable next steps.
