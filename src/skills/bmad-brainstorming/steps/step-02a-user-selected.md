...
After technique confirmation, load `{{AGENT_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-03-technique-execution.md` to begin facilitating the selected brainstorming techniques.
