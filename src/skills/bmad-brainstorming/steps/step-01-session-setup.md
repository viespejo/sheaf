...
- If user selects **[1]** (continue): Set `{brainstorming_session_output_file}` to that file path and load `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-01b-continue.md`
...
- **If 1:** Load `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-02a-user-selected.md`
- **If 2:** Load `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-02b-ai-recommended.md`
- **If 3:** Load `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-02c-random-selection.md`
- **If 4:** Load `{{RUNTIME_DIR}}/sheaf/skills/bmad-brainstorming/steps/step-02d-progressive-flow.md`
