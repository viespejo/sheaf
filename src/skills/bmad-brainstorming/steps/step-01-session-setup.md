...
- If user selects **[1]** (continue): Set `{brainstorming_session_output_file}` to that file path and load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-01b-continue.md`
...
- **If 1:** Load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-02a-user-selected.md`
- **If 2:** Load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-02b-ai-recommended.md`
- **If 3:** Load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-02c-random-selection.md`
- **If 4:** Load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-02d-progressive-flow.md`
