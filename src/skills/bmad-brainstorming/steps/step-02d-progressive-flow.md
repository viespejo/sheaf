...
After user confirmation, load `{{SHEAF_RUNTIME_DIR}}/skills/bmad-brainstorming/steps/step-03-technique-execution.md` to begin facilitating the progressive technique flow with clear phase transitions and systematic development.
