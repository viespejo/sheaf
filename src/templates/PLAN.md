...
Template for `.sheaf/phases/{phase-number}-{name}/{phase}-{plan}-PLAN.md` - executable phase plans.
...
<!-- If .sheaf/SPECIAL-FLOWS.md exists, this section is auto-populated by /sheaf:plan -->
...
<output>
After completion, create `.sheaf/phases/XX-name/{phase}-{plan}-SUMMARY.md`
</output>
```
