...
Template for `.sheaf/STATE.md` — the project's living memory.
...
See: .sheaf/PROJECT.md (updated [YYYY-MM-DD])
...
### Loop Position
**Purpose:** Visual indicator of SHEAF loop state.
**States:**
...
- Set position to "Ready for first PLAN"
